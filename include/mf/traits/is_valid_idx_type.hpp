...
namespace mf {
namespace detail {
template<typename IdxType> struct is_valid_idx_type_helper: false_type {};
...
struct is_valid_idx_type: detail::is_valid_idx_type_helper<typename remove_cv<IdxType>::type> {};
} // namespace mf
