...
namespace mf {
static MF_CONST_OR_CONSTEXPR float_max_t PI = MF_FLOAT_CONST(3.141592653589793238462643383279502884);
static MF_CONST_OR_CONSTEXPR float_max_t SQRT2 = MF_FLOAT_CONST(1.414213562373095048801688724209698079);
static MF_CONST_OR_CONSTEXPR float_max_t SQRT1_2 = MF_FLOAT_CONST(1.0) / SQRT2;
